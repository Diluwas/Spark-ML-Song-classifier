...
public class LyricsController {
    ...
    ResponseEntity<Map<String, Object>> trainLyricsModel(@RequestBody String fileName) throws IOException {
        Map<String, Object> trainStatistics = lyricsService.classifyLyrics(fileName);
